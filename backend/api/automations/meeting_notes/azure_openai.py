...
def _create_note(system_prompt: str, transcript_text: str, max_tokens: int) -> str:
    ...
    # Reuse the shared Responses-API call (task_summary_report/azure_openai.py) —
    # this deployment doesn't accept the legacy chat.completions max_tokens param.
    return _shared._create_completion(messages, max_tokens)
